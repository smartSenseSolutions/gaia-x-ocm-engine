...
postgresql://{{ .Values.connectionManager.database.user }}:{{ .Values.connectionManager.database.password }}@{{ .Values.connectionManager.database.host }}:{{ .Values.connectionManager.database.port }}/{{ .Values.connectionManager.database.db }}?schema={{ .Values.connectionManager.database.schema }}
{{- end -}}
