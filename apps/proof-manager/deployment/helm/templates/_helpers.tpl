...
postgresql://{{ .Values.proofManager.database.user }}:{{ .Values.proofManager.database.password }}@{{ .Values.proofManager.database.host }}:{{ .Values.proofManager.database.port }}/{{ .Values.proofManager.database.db }}?schema={{ .Values.proofManager.database.schema }}
{{- end -}}
