...
const BufferEncoder_1 = require("./BufferEncoder");
...
class HashlinkEncoder {
    ...
    static encodeMultiHash(buffer, hashName, baseEncoding = 'base58btc') {
        // TODO: Support more hashing algorithms
        const hash = new Uint8Array(js_sha256_1.sha256.array(buffer));
        const mh = MultiHashEncoder_1.MultiHashEncoder.encode(hash, hashName);
        const mb = MultiBaseEncoder_1.MultiBaseEncoder.encode(mh, baseEncoding);
        return BufferEncoder_1.BufferEncoder.toUtf8String(mb);
    }
    static encodeMetadata(metadata, baseEncoding) {
        ...
        return BufferEncoder_1.BufferEncoder.toUtf8String(multibaseMetadata);
    }
