...
let CacheRepository = class CacheRepository extends Repository_1.Repository {
    constructor(storageService) {
        super(CacheRecord_1.CacheRecord, storageService);
    }
};
CacheRepository = __decorate([
    tsyringe_1.scoped(tsyringe_1.Lifecycle.ContainerScoped),
    __param(0, tsyringe_1.inject(constants_1.InjectionSymbols.StorageService)),
