...
class ProblemReportMessage extends AgentMessage_1.AgentMessage {
    ...
    constructor(options) {
        super();
        this.type = ProblemReportMessage.type;
        if (options) {
...
ProblemReportMessage.type = 'https://didcomm.org/notification/1.0/problem-report';
__decorate([
    class_validator_1.Equals(ProblemReportMessage.type),
    __metadata("design:type", String)
], ProblemReportMessage.prototype, "type", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_transformer_1.Expose({ name: 'problem_items' }),
    __metadata("design:type", Array)
], ProblemReportMessage.prototype, "problemItems", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_validator_1.IsEnum(WhoRetriesStatus),
    class_transformer_1.Expose({ name: 'who_retries' }),
    __metadata("design:type", String)
], ProblemReportMessage.prototype, "whoRetries", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_transformer_1.Expose({ name: 'fix_hint' }),
    __metadata("design:type", Object)
], ProblemReportMessage.prototype, "fixHint", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_validator_1.IsEnum(WhereStatus),
    __metadata("design:type", String)
], ProblemReportMessage.prototype, "where", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_validator_1.IsEnum(ImpactStatus),
    __metadata("design:type", String)
], ProblemReportMessage.prototype, "impact", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    class_transformer_1.Expose({ name: 'noticed_time' }),
    __metadata("design:type", String)
], ProblemReportMessage.prototype, "noticedTime", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    class_transformer_1.Expose({ name: 'tracking_uri' }),
    __metadata("design:type", String)
], ProblemReportMessage.prototype, "trackingUri", void 0);
__decorate([
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    class_transformer_1.Expose({ name: 'escalation_uri' }),
    __metadata("design:type", String)
