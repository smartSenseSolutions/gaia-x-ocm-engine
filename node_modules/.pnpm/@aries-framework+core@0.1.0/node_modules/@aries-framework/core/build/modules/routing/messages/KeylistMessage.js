...
class KeylistMessage extends AgentMessage_1.AgentMessage {
    constructor(options) {
        super();
        this.type = KeylistMessage.type;
        if (options) {
            this.id = options.id || this.generateId();
        }
    }
}
KeylistMessage.type = 'https://didcomm.org/coordinate-mediation/1.0/keylist';
__decorate([
    class_validator_1.Equals(KeylistMessage.type),
    __metadata("design:type", Object)
], KeylistMessage.prototype, "type", void 0);
__decorate([
    class_transformer_1.Type(() => Keylist),
