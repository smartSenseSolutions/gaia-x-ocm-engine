...
class MediationRequestMessage extends AgentMessage_1.AgentMessage {
    ...
    constructor(options) {
        super();
        this.type = MediationRequestMessage.type;
        if (options) {
...
MediationRequestMessage.type = 'https://didcomm.org/coordinate-mediation/1.0/mediate-request';
__decorate([
    class_validator_1.Equals(MediationRequestMessage.type),
...
], MediationRequestMessage.prototype, "sentTime", void 0);
