...
__decorate([
    class_transformer_1.Expose({ name: 'schema_id' }),
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    __metadata("design:type", String)
], AttributeFilter.prototype, "schemaId", void 0);
__decorate([
    class_transformer_1.Expose({ name: 'schema_issuer_did' }),
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    __metadata("design:type", String)
], AttributeFilter.prototype, "schemaIssuerDid", void 0);
__decorate([
    class_transformer_1.Expose({ name: 'schema_name' }),
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    __metadata("design:type", String)
], AttributeFilter.prototype, "schemaName", void 0);
__decorate([
    class_transformer_1.Expose({ name: 'schema_version' }),
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    __metadata("design:type", String)
], AttributeFilter.prototype, "schemaVersion", void 0);
__decorate([
    class_transformer_1.Expose({ name: 'issuer_did' }),
    class_validator_1.IsOptional(),
    class_validator_1.IsString(),
    __metadata("design:type", String)
...
__decorate([
    class_validator_1.IsOptional(),
    class_transformer_1.Type(() => AttributeValue),
    class_validator_1.ValidateNested(),
    class_validator_1.IsInstance(AttributeValue),
...
function AttributeFilterTransformer() {
    return class_transformer_1.Transform(({ value: attributeFilter, type: transformationType }) => {
