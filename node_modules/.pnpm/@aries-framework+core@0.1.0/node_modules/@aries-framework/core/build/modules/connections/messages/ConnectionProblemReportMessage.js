...
class ConnectionProblemReportMessage extends ProblemReportMessage_1.ProblemReportMessage {
    ...
    constructor(options) {
        super(options);
        this.type = ConnectionProblemReportMessage.type;
    }
}
ConnectionProblemReportMessage.type = 'https://didcomm.org/connection/1.0/problem-report';
__decorate([
    class_validator_1.Equals(ConnectionProblemReportMessage.type),
