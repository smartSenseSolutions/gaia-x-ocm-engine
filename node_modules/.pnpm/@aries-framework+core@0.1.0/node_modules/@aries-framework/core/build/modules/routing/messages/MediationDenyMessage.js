...
class MediationDenyMessage extends AgentMessage_1.AgentMessage {
    constructor(options) {
        super();
        this.type = MediationDenyMessage.type;
        if (options) {
            this.id = options.id;
        }
    }
}
MediationDenyMessage.type = 'https://didcomm.org/coordinate-mediation/1.0/mediate-deny';
__decorate([
    class_validator_1.Equals(MediationDenyMessage.type),
