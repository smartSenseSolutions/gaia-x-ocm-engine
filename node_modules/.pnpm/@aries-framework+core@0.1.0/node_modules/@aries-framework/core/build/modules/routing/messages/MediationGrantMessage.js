...
class MediationGrantMessage extends AgentMessage_1.AgentMessage {
    constructor(options) {
        var _a;
        super();
        this.type = MediationGrantMessage.type;
        if (options) {
...
MediationGrantMessage.type = 'https://didcomm.org/coordinate-mediation/1.0/mediate-grant';
__decorate([
    class_validator_1.Equals(MediationGrantMessage.type),
    __metadata("design:type", Object)
], MediationGrantMessage.prototype, "type", void 0);
__decorate([
    class_validator_1.IsNotEmpty(),
    class_validator_1.IsArray(),
    class_transformer_1.Expose({ name: 'routing_keys' }),
