...
class WsOutboundTransport {
    ...
    async start(agent) {
        this.agent = agent;
        const agentConfig = agent.injectionContainer.resolve(AgentConfig_1.AgentConfig);
        this.logger = agentConfig.logger;
        this.eventEmitter = agent.injectionContainer.resolve(EventEmitter_1.EventEmitter);
