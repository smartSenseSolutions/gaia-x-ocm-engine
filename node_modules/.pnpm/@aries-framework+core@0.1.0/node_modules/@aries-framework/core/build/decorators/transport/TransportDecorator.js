...
__decorate([
    class_transformer_1.Expose({ name: 'return_route' }),
    class_validator_1.IsEnum(ReturnRouteTypes),
    class_validator_1.IsOptional(),
    __metadata("design:type", String)
], TransportDecorator.prototype, "returnRoute", void 0);
__decorate([
    class_transformer_1.Expose({ name: 'return_route_thread' }),
    class_validator_1.ValidateIf((o) => o.returnRoute === ReturnRouteTypes.thread),
