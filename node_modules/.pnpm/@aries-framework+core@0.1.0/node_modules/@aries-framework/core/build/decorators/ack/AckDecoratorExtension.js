...
function AckDecorated(Base) {
    class AckDecoratorExtension extends Base {
        setPleaseAck() {
            this.pleaseAck = new AckDecorator_1.AckDecorator();
        }
        getPleaseAck() {
    ...
    __decorate([
        class_transformer_1.Expose({ name: '~please_ack' }),
        class_transformer_1.Type(() => AckDecorator_1.AckDecorator),
        class_validator_1.ValidateNested(),
        class_validator_1.IsInstance(AckDecorator_1.AckDecorator),
