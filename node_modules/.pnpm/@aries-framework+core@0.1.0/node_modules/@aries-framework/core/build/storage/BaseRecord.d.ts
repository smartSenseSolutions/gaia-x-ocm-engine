...
export declare type TagValue = string | boolean | undefined | Array<string>;
export declare type TagsBase = {
    [key: string]: TagValue;
    [key: number]: never;
};
export declare type Tags<DefaultTags extends TagsBase, CustomTags extends TagsBase> = CustomTags & DefaultTags;
export declare type RecordTags<Record extends BaseRecord> = ReturnType<Record['getTags']>;
